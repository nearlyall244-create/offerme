...
const GROUP_META = {
  'food-drinks': {
    eyebrow: 'EAT & ENJOY',
    description: 'Find a new favourite close to you.',
    icon: Utensils,
    color: '#f97316',
    lightBg: '#fff7ed',
  },
  'grocery-supermarkets': {
    eyebrow: 'FRESH DAILY',
    description: 'Fresh essentials for every kind of day.',
    icon: ShoppingCart,
    color: '#10b981',
    lightBg: '#ecfdf5',
  },
  'fashion-clothing': {
    eyebrow: 'WEAR YOUR WAY',
    description: 'Style, gifts, and little luxuries.',
    icon: Shirt,
    color: '#8b5cf6',
    lightBg: '#f5f3ff',
  },
  'beauty-personal': {
    eyebrow: 'GLOW & RELAX',
    description: 'Self-care, spas, and wellness treats.',
    icon: Sparkles,
    color: '#ec4899',
    lightBg: '#fdf2f8',
  },
  'electronics-mobiles': {
    ...
    description: 'Latest devices, repair, and accessories.',
    icon: Smartphone,
    color: '#0ea5e9',
    lightBg: '#f0f9ff',
  },
  'home-furniture': {
    ...
    description: 'Furnish, decorate, and elevate your space.',
    icon: Home,
    color: '#d97706',
    lightBg: '#fffbeb',
  },
  ...
  'education': {
    eyebrow: 'LEARN & GROW',
    description: 'Top tutors, coaching, and skills training.',
    icon: GraduationCap,
    color: '#6366f1',
    lightBg: '#eef2ff',
  },
  'professional-services': {
    eyebrow: 'BUSINESS & EXPERTS',
    description: 'Legal, tax, consulting, and pros.',
    icon: Briefcase,
    color: '#2563eb',
    lightBg: '#eff6ff',
  },
  'travel': {
    eyebrow: 'EXPLORE & GO',
    description: 'Bookings, transport, and holiday packages.',
    icon: Plane,
    color: '#06b6d4',
    lightBg: '#ecfeff',
  },
  'events-entertainment': {
    eyebrow: 'CELEBRATE & PLAY',
    description: 'DJs, wedding planners, and festivities.',
    icon: PartyPopper,
    color: '#d946ef',
    lightBg: '#fdf4ff',
  },
  ...
  'pet-services': {
    eyebrow: 'PET LOVERS',
    description: 'Vets, grooming, and pet supplies.',
    icon: PawPrint,
    color: '#84cc16',
    lightBg: '#f7fee7',
  },
  'cloth-services': {
    eyebrow: 'CLEAN & CRISP',
    description: 'Tailors, laundry, and dry cleaners.',
    icon: Scissors,
    color: '#a855f7',
    lightBg: '#faf5ff',
  },
